...
export default function AdminPage() {
  ...
  if (!address) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center wood-panel rounded p-6 sm:p-12 border-4 border-wood-900 shadow-2xl">
        <DoorOpen className="w-12 h-12 sm:w-16 sm:h-16 mb-6 text-cream/60" />
        <h1 className="text-2xl sm:text-4xl font-rye tracking-widest text-cream mb-4">Saloon Doors Locked</h1>
        <p className="font-special text-cream/70 text-base sm:text-lg">Draw your wallet to enter the Sheriff&apos;s Office.</p>
      </div>
    )
  }
  ...
  if (!isArbitrator) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center wood-panel rounded p-6 sm:p-12 border-4 border-wood-900 shadow-2xl relative overflow-hidden">
        <div className="absolute inset-0 bg-blood/10 pointer-events-none" />
        <Skull className="w-12 h-12 sm:w-16 sm:h-16 mb-6 drop-shadow-lg text-blood z-10" />
        <h1 className="text-2xl sm:text-4xl font-rye tracking-widest text-cream mb-4 z-10">Turn Back, Partner</h1>
        <p className="font-special text-cream/80 text-base sm:text-lg z-10">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="wood-panel p-5 sm:p-8 rounded border-4 border-wood-900 shadow-xl relative">
        ...
        <h1 className="text-2xl sm:text-4xl font-rye tracking-widest text-cream mb-3 drop-shadow-md">Sheriff&apos;s Office</h1>
        <p className="font-special text-cream/80 text-base sm:text-lg leading-relaxed max-w-lg">
